...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x21b1c8;
...
const char     CRYPTONOTE_NAME[]                             = "albaselcoin";
...
const int      P2P_DEFAULT_PORT                              = 8812;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 8813;
